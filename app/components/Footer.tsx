  ...
  return (
    <footer className="bg-[#1a3a2a] border-t-4 border-[#c9a84c] py-8 px-4 text-center">
      ...
      <div className="flex justify-center gap-4 mb-4">
        <a href="https://wa.me/51999000000" target="_blank" className="text-green-400 hover:text-green-300 text-sm transition-colors">💬 WhatsApp</a>
        <a href="https://facebook.com/premioshuambrillo" target="_blank" className="text-blue-300 hover:text-blue-200 text-sm transition-colors">🔵 Facebook</a>
